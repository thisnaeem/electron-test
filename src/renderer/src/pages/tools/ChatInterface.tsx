      ...
      <div className="flex-1 overflow-y-auto">
          ...
          {messages.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full min-h-[500px] text-center">
              <div className="w-20 h-20 bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl flex items-center justify-center mb-6 shadow-xl">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="32"
                  height="32"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-2xl">
                <div className="bg-white dark:bg-gray-800 rounded-xl p-4 text-left border border-gray-200 dark:border-gray-700 hover:border-blue-300 dark:hover:border-blue-600 transition-colors">
                ...
                <div className="bg-white dark:bg-gray-800 rounded-xl p-4 text-left border border-gray-200 dark:border-gray-700 hover:border-purple-300 dark:hover:border-purple-600 transition-colors">
                  <div className="text-base font-semibold text-gray-900 dark:text-gray-100 mb-1">
                    General chat
                  </div>
                  <div className="text-sm text-gray-500 dark:text-gray-400">
      ...
      <div className="flex-shrink-0 bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700">
          ...
          <div className="flex items-end gap-4">
            ...
            <button
              ...
              className="flex-shrink-0 w-12 h-12 flex items-center justify-center rounded-xl border-2 border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600 hover:border-blue-400 dark:hover:border-blue-500 transition-colors shadow-sm"
              title="Upload images"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="flex-1 relative">
              <textarea
                ...
                } bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 px-4 py-3 pr-14 focus:outline-none text-sm transition-all`}
                rows={1}
              ...
              <button
                ...
                className={`absolute right-3 bottom-3 w-10 h-10 flex items-center justify-center rounded-lg transition-all ${
